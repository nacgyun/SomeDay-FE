      ...
      <div className="w-full max-w-[400px] z-10">
        ...
        <div className="bg-white/[0.05] backdrop-blur-xl border border-white/10 rounded-3xl p-8">
          <div className="flex flex-col gap-4 mb-2">
            ...
            <Button id="login-btn" fullWidth onClick={handleLogin} disabled={isLoading} className="mt-2">
              {isLoading ? '로그인 중...' : '로그인'}
            </Button>
          </div>

          {/* 구분선 */}
          <div className="flex items-center gap-3 text-white/30 text-[13px] my-4">
          ...
          <p className="text-center text-white/45 text-[13px] mt-6">
            아직 계정이 없으신가요?{' '}
