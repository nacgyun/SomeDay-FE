  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={[
          ...
          mission.done
            ...
            : 'bg-transparent border-white/25 text-white/0',
        ].join(' ')}
      >
        {mission.done ? '✓' : ''}
      </button>
      ...
      <div className="flex-1 min-w-0">
        <p className="text-[14px] font-semibold text-white mb-0.5 truncate">{mission.title}</p>
      ...
      <div className="flex flex-col items-end flex-shrink-0">
        ...
        <span className="text-[10px] text-white/40">pt</span>
      </div>
    </div>
  );
};
